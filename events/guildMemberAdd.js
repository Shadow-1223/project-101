...
Canvas.registerFont('./JetBrainsMono-Regular.ttf', { family : 'JetBrains' })
...
module.exports = {
    ...
    async run(client , member) {
        ...
        welcomeCanvas.context.font = '72px JetBrains';
        welcomeCanvas.context.fillStyle = '#ffffff';
        
        Canvas.loadImage("./Images/Welcomebg.jpg").then(async (img) => {
        ...
        canvas.context.font = '42px JetBrains',
        canvas.context.textAlign = 'center';
        canvas.context.fillText(member.user.tag.toUpperCase(), 512, 410)
        canvas.context.font = '32px JetBrains'
